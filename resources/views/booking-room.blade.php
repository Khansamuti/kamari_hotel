...
<section class="hero-section set-bg" data-setbg="img/rooms-bg.jpg">
        <div class="hero-text">
            <div class="container">
                ...
                <div class="page-nav">
                    <a href="/bookingform" class="left-nav"><i class="lnr lnr-arrow-left"></i> Back to Form</a>
                </div>
            </div>
        </div>
    </section>
...
<!-- sebenarnya pengennya nanti yang dimunculin tu kamar yang available aja-->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="room-text">
                            ...
                            <a href="/bookingform" class="primary-btn">Book Now <i class="lnr lnr-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
