...
@section('title', 'Contact Us | Hotel Name')
 ...
 <section class="hero-section set-bg" data-setbg="img/contact-bg.jpg">
        <div class="hero-text">
            <div class="container">
                ...
                <div class="page-nav">
                    <a href="/rooms" class="left-nav"><i class="lnr lnr-arrow-left"></i> Rooms</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-6">
                    <div class="contact-left">
                        <div class="contact-information">
                            ...
                            <ul>
                                <li><img src="img/placeholder-copy.png" alt=""> <span>Gedung Nano, Universitas Airlangga,
                                        SBY</span></li>
                                <li><img src="img/phone-copy.png" alt=""> <span>+62-1234-5678</span></li>
                                <li><img src="img/envelop.png" alt=""> <span>kamari@gmail.com</span></li>
